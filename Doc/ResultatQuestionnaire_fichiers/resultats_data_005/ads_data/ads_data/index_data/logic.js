...
function fetchData() {
  Enabler.setProfileId(10030473);
  var devDynamicContent = {};

  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1= [{}];
  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0]._id = 0;
  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].Unique_ID = 1;
  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].Reporting_Label = "Expedia_728x90";
  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].Exit_URL = "";

  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].Frame_0_copy_text = 'EXPERIENCE LONDON';
  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].Frame_0_copy_font_size = '24';
  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].Frame_1_copy_text = 'Book your flight';
  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].Frame_1_copy_font_size = '24';
  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].Frame_2_copy_text = 'your hotel';
  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].Frame_2_copy_font_size = '24';
  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].Frame_3_copy_text = 'and your activity';
  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].Frame_3_copy_font_size = '24';
  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].Frame_4_copy_text = 'all in one place';
  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].Frame_4_copy_font_size = '24';

  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].Frame_5_copy_A_text = 'everything';
  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].Frame_5_copy_A_font_size = '40';
  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].Frame_5_copy_B_text = 'you need to go';
  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].Frame_5_copy_B_font_size = '30';
  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].Frame_5_copy_C_text = '';
  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].Frame_5_copy_C_font_size = '30';

  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].EndFrame_cta = 'Build your trip';
  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].EndFrame_cta_font_size = '18';

  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].EndFrameLogoAsset = {};
  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].EndFrameLogoAsset.Type = "file";
  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].EndFrameLogoAsset.Url = "https://s0.2mdn.net/ads/richmedia/studio/11561/11561_20180129043722653_findYourBritain.jpg";
  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].Image1Asset = {};
  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].Image1Asset.Type = "file";
  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].Image1Asset.Url = "https://s0.2mdn.net/ads/richmedia/studio/11561/11561_20180129043736339_image1.jpg";
  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].Image2Asset = {};
  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].Image2Asset.Type = "file";
  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].Image2Asset.Url = "https://s0.2mdn.net/ads/richmedia/studio/11561/11561_20180129043748142_image2.jpg";
  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].Image3Asset = {};
  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].Image3Asset.Type = "file";
  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].Image3Asset.Url = "https://s0.2mdn.net/ads/richmedia/studio/11561/11561_20180129043802345_image3.jpg";
  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].Image4Asset = {};
  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].Image4Asset.Type = "file";
  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].Image4Asset.Url = "https://s0.2mdn.net/ads/richmedia/studio/11561/11561_20180129043814764_image4.jpg";
  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].LogoEndAsset = {};
  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].LogoEndAsset.Type = "file";
  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].LogoEndAsset.Url = "https://s0.2mdn.net/ads/richmedia/studio/11561/11561_20180129043827264_logoEnd.png";
  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].isActive = true;

  devDynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0].disableIcons = false;
 ...
 */
function init() {
  data.setData(dynamicContent.Expedia_Dynamic_Toolkit_FR_London_Sheet1[0]);
  setupCopyTexts();
  setupImages();
